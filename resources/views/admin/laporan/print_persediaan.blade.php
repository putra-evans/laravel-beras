    ...
    <table id="table">
        <thead>
            <tr>
                ...
                <th width="15%" class="font-weight-bold text-center">Persediaan Akhir</th>
        ...
        <tbody>
            ...
            @foreach ($persediaan as $key => $pecah)
                <tr>
                    ...
                    <td>{{ $pecah->judul_produk }} Kg</td>
                    <td style="text-align: center">{{ $pecah->persediaan_awal }} Kg</td>
                    <td style="text-align: center">{{ $pecah->persediaan_sisa }} Kg</td>
                    <td style="text-align: center">{{ $pecah->terjual }} Kg</td>
                </tr>
        ...
        <tfoot>
            <tr>
                ...
                <td style="font-style: bold;text-align: center">{{ $totals }} Kg</td>
            </tr>
        </tfoot>
    </table>
    <br>
