            ...
            if (user_id != '') {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(index, item) {
                            ...
                            html += `
                                <tr class="table_row">
                                    ...
                                    <td class="column-3"><button type="button"
                                    data-id="${item.id_keranjang}"
                                    data-id_produk="${item.id_produk}"
                                    data-id_user="${item.id_user}"
                                    class="btn btn-sm btn-danger DeleteDataKeranjang">Delete</button></td>
                                </tr>
                            `;
                        });
                        ...
                        $(".DeleteDataKeranjang").on("click", function(event) {
                            let id_keranjang = $(this).data('id');
                            let id_produk = $(this).data('id_produk');
                            let id_user = $(this).data('id_user');
                            $.ajax({
                                type: 'GET',
                                ...
                                dataType: 'json',
                                success: function(data) {
                                    swal("Pemesanan", "Berhasil hapus Produk", "success");
                                    window.location.reload();
                                },
                                error: function(err) {
                                    alert("Error");
