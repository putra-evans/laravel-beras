...
@section('contents')
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url({{asset('assets_front/toko.jpg')}});">
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl6 size-213 p-t-18">
								Jl. Pasir Sebelah No.41, Pasie Nan Tigo, Kec. Koto Tangah, Kota Padang, Sumatera Barat 25586
							</p>
						</div>
					</div>
